...
<h3 align="center">Desenvolvedor Full Stack | UI/UX Designer | Especialista em Dashboards & Soluções Web</h3>
...
## 🚀 Sobre Mim
Sou um Desenvolvedor Full Stack apaixonado por transformar fluxos de negócios complexos em interfaces intuitivas e processos eficientes. Com experiência sólida em **React, Next.js e Node.js**, meu foco está na criação de Dashboards operacionais e integrações de alta disponibilidade. 

Ao longo da minha trajetória, desenvolvi soluções que abrangem desde telemetria em tempo real (**Rastrear Já**) até sistemas de automação financeira e fiscal (**I.A.R.A** e **Integradores de NF**). Meu diferencial é unir a precisão técnica do Back-end com uma visão apurada de **UI/UX Design** projetada no Figma.
